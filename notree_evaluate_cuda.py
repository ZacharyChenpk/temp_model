...
def model_load(fn):
    global model_pos, model_encoder, model_word, optimizer, weight, out_embedding, outtree_embedding
    if args.philly:
...
def encode2seq(model_pos, model_encoder, model_word, code, hiddens, corpus, threshold, strategy='greedy'):
    ...
    while True:
        if strategy == 'greedy':
            ...
            curtree.insert_son(tar_pos, chosen_word, outtree_embedding, Training=False)
